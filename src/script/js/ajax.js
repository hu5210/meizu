    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (i, val) {
                if (i < 4) {
                    str += "<li class='adv-box-1'><a href='http://localhost/projectname/src/details.html?" + val.sid + "'><img src='" + val.url + "'><em>" + val.title + "</em><p style='color:red;font-size:20px'>" + val.pice + "</p></a></li>";
                }
            })
            str += "</ul>";
            $('#adv').html(str);
                ...
                temp += `
                            ...
                            <div class="section-item-box goods-box">
                                <a class="box-img box-img-retina"
                                    href="http://localhost/projectname/src/details.html?${eml.sid}"
                                    target="_blank">

                                    <img class="goods-img lazy"
                                    width="230px" height="230px"
                                         data-original="${eml.url}">
                                    <span class="box-info">
